...
Please also ensure that software version numbers are in the standard version number format A[.B.C.D.E...] (where A, B, C, D, E... are positive integers or 0 e.g 1.0.8), and that you do not mix version numbering conventions.
